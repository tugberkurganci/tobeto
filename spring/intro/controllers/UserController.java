...
import com.tobeto.a.spring.intro.services.models.responses.GenericMessage;
...
public class UserController {
    ...
    @PostMapping
    public GenericMessage createUser(@RequestBody List<CreateUserRequest> userRequest) {
        userService.createUser(userRequest);

        return new GenericMessage("User created name:"+userRequest.get(0).getName());
