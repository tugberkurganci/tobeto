...
public class InvoiceController {
    ...
    @PostMapping
    public GetInvoiceResponse add (@RequestBody CreateInvoiceRequest createInvoiceRequest ){
    ...
    public GetInvoiceResponse getInvoiceByRentalId(@PathVariable("rentalId")  Integer rentalId){
