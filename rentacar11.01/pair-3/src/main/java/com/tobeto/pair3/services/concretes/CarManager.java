...
public class CarManager implements CarService {
    ...
    public CarManager(CarRepository carRepository, ModelService modelService, ColorService colorService, ModelMapperService mapperService, RentalRules rentalRules) {
    ...
    public List<CarModelResponse> getRentableCars(RentableRequest rentableRequest) {
        ...
        rentalRules.checkEndDateIsBeforeStartDate(rentableRequest.getDropoffDate(),rentableRequest.getPickupDate());
        ...
        carList.forEach(car -> {
            ...
            if (isSuitable){car.setDailyPrice(setTotalPriceToCar(car.getDailyPrice(),rentableRequest));  carList2.add(car);}
