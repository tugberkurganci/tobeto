...
public class CarSupplierController {
    ...
    @PostMapping
    public void createCarSupplier(@RequestBody List<CreateCarSupplierRequest> carSupplierRequest) {
    ...
    @GetMapping("/getCarSuppliersbyLocation")
    public List<CarSupplierResponse> getCarSuppliersbyLocation(@RequestParam String location){
        return carSupplierService.findByLocation(location);

    }

    @GetMapping("/getCarSuppliersAndCarInfo")
    public List<CarResponse> getCarSuppliersAndCarInfo(@RequestParam String carSupplierName){
        return carSupplierService.getCarSuppliersAndCarInfo(carSupplierName);
